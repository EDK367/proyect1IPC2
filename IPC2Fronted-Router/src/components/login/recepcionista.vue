<template>
  <div>
    ...
    <v-card
      ...
      rounded="lg"
    >
      <div class="text-subtitle-1 text-medium-emphasis">Recepcionista</div>
      ...
      >
        <v-card-text>
          ...
          <div class="invalid">
            ...
            <br>
            O comunicarse con su operador o un Administrador General
          </div>
        </v-card-text>
      </v-card>
    </v-bottom-sheet>
