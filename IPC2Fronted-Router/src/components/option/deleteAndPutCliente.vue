      ...
      >
        <v-card-text>
          ...
          <div>
           ...
           <br>
           El NIT ya existe en otro usuario
           <br>
...
export default {
  ...
  methods: {
    ...
    cargaDatos() {
      ...
      if (optionUser) {
        this.cuiOperador = optionUser.cuiOperador;
        this.cuiRecepcionista = optionUser.cuiRecepcionista;
        this.NIT = optionUser.NIT;
        this.nombre = optionUser.nombre;
        this.apellido = optionUser.apellido;
        this.phone = optionUser.telefono;
      } else {
    ...
    submitForm() {
      ...
      axios
      .put("http://localhost:8080/backendIPC2/api/cliente", update)
      .then((response) => {
